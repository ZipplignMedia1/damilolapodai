...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DAMILOLAPOD AI — Be Creative with AI" },
      { name: "description", content: "Generate stunning videos from text or images using AI." },
      { property: "og:title", content: "DAMILOLAPOD AI — Be Creative with AI" },
      { name: "twitter:title", content: "DAMILOLAPOD AI — Be Creative with AI" },
      { property: "og:description", content: "Generate stunning videos from text or images using AI." },
      { name: "twitter:description", content: "Generate stunning videos from text or images using AI." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/0269ddc2-a336-4f72-8b00-f977b38526a6" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/0269ddc2-a336-4f72-8b00-f977b38526a6" },
